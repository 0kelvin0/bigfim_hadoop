...
public class BigFIMDriver extends Configured implements Tool {
	...
	private static int count = 0; // for counting #MR tasks, for time calculation.
	...
	public static void saveResult(double totalTime){
		try{
			...
			if(!resultFile.exists()){
				...
				br.write("algo" + "\t" + "dataset" + "\t" + "DBSize" + "\t" + "minSup(%)" + "\t" + "#Mappers" + "\t" + "prefixLength" + "\t" + "TotalFrequentPattern" + "\t" + "TotalTime" + "\t" + "TotalJobTime"  + "\t");
				br.write("\n");
				// for( int i = 0; i<eachLeveltidsetItemsetsNum.size(); i++)  {
				// 	br.write("Lvl_" + (i+1) + "\t");
				// }
			...
			br.write("BigFIM" + "\t" + dataBaseName + "\t" + dataSize + "\t" + relativeMinSupport * 100.0 + "\t\t" + numMappers + "\t\t" + prefix_length + "\t\t" + TotalFrePattern + "\t\t" + totalTime + "\t\t" +TotalJobRunningTime + "\t");
			br.write("\n");
			// for( int i = 0; i<eachLeveltidsetItemsetsNum.size(); i++)  {
